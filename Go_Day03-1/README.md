...
Now let's implement our main piece of functionality - searching for _three_ closest restaurants! In order to do that, you'll have to configure sorting for your query:
